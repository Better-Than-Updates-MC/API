...
public class MinecraftForgeClient {
	 ...
	 * @deprecated use {@link BlockEvents#BLOCK_HIGHLIGHT}
	 * @see net.fabricmc.fabric.api.event.Event#register
	 */
	public static void registerHighlightHandler(BlockEvents.BlockHighlight handler) {
		BlockEvents.BLOCK_HIGHLIGHT.register(handler);
	}
